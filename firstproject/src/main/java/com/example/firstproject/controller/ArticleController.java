...
@Controller
@Slf4j  // 로깅을 위한 롬복 어노체이션
public class ArticleController {
//    private final ArticleRepository articleRepository;
//    @Autowired
//    public AtricleController(ArticleRepository articleRepository) {
//        this.articleRepository = articleRepository;
//    }
    @Autowired
    private ArticleRepository articleRepository;
    // 스프링 부트가 미리 생성해 놓은 레파지토리 객체를 가져옴(DI)
    ...
    public String CrudRepository(ArticleForm form){
        // Article.java의 String 을 가져온다
...
//        System.out.println(article.toString());
        ...
        // articleRepository 에 저장
        Article saved = articleRepository.save(article);
        // Article 엔티티를 데이터베이스에 저장
        // ArticleForm.java의 String에 Article을 가져와 추가해주고 Article.java에서
        // 넣어준 id 값을 넣는다.
...
//         Article articleEntity = optionalArticle.orElse(null);
        ...
        // 우리는 결과를 받을 Optional<Article> 변수 선언
        // orElse() 메서드를 사용하여 Optional 객체 안의 값이 존재하면 해당 값을 반환
        // 값이 없느면 null 값을 가지게 됩니다.
