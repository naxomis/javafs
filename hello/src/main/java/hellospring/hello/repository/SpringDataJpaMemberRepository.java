...
// 인터페이스 안으로 개발을 완료할 수 있다. 그리고 반복 개발해온 기본 CRUD 기능도
// 스프링 데이터 JPA 가 모두 제공된다.
...
// TIP
// 실무에서는 JPA와 스프링 데이터 JPA 를 기본적으로 사용하고,
// 복잡한 동적퀄리는 Querydsl 이라는 라이브러리를 사용하면 된다.
// Querydsl 을 사용하면 쿼리도 자바 코드로 안전하게 작성할 수 있고, 동적 쿼리도 편리하게 작성할 수 있다.
// 이 조합으로 해결하기 어려운 쿼리는 JPA가 제공하는 네이티브 쿼리를 사용하거나, JdbcTemplate 를 사용하면 된다.